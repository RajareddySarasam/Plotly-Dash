...
app.layout = html.Div([
   ...
   html.Div(dcc.Dropdown(
    ...
    html.Div(id='output-container', className='chart-grid', style={'display':'table'}),])
])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unempl = recession_data.groupby(['Vehicle_Type','Automobile_Sales'])['unemployment_rate'].mean().reset_index()
